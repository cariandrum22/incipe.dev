...
![cpptools client: couldn't create connection to server.](/content-assets/blog/using-microsofts-c-cpp-extension-with-vs-code-on-nixos/ms-vscode.cpptools-error.png)
