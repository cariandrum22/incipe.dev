...
![xdg-open dialog after GitHub authentication on Google Chrome](/content-assets/contentful/7fjVudvnKeYdKcxLgzsP2y/2023-07-27_22-24.png)

ここで，`Open xdg-open`ボタンを押下したにも関わらず，VS Codeに結果が戻ってこない．

![Authentication waiting dialog in VS Code](/content-assets/contentful/6IuijCcjb7tnYhd8q6oBfl/2023-07-27_22-25.png)

VS Code側ではサインイン中の表示が出ており，最終的にタイムアウトしてしまった．

![Warning dialog for fallback when authentication is not finiched](/content-assets/contentful/105ia30Ca99reUtYFZw4vU/2023-07-27_22-33.png)
...
![An OS keyring couldn't be identified for storing the encryption related data in your current desktop environment](/content-assets/contentful/6nz6gKt7ndcHVtv0FUzlfS/2023-07-27_22-35.png)
...
![You're running in a GNOME Environment but the OS keyring is not available for encryption](/content-assets/contentful/av7TXNUNZhOXy1MEhoSg4/2023-07-27_23-33.png)
